...
let categoriaDoJogo = Number(prompt("Informe a categoria do jogo."))
...
function valorDoIngresso (etapaDoJogo){
    switch (etapaDoJogo){
    case "SF":
        calculoDoValorUnitario = semiFinais[categoriaDoJogo]
        return valorUnitario
    case "DT":
        calculoDoValorUnitario = decisaoTerceirao[categoriaDoJogo]
        return valorUnitario
    case "FI":
        valorcalculoDoValorUnitarioUnitario = final[categoriaDoJogo]
        return valorUnitario
    default:
...
if (domesticoOuInternacional === false) {

    let conversaoEmDolares = valorUnitarioDoIngresso * 4.10

    let valorTotalDosIngressos = conversaoEmDolares * quantidadeDeIngressosASerComprada

    console.log(`Olá, ${nomeDoUsuario}. Você requereu ${quantidadeDeIngressosASerComprada} ingressos da ${etapaDoJogo} da categoria ${categoriaDoJogo}. Cada ingresso terá o valor de ${conversaoEmDolares} e o total a ser pago será de ${valorTotalDosIngressos}.`)

} else {

    let valorTotalDosIngressos = quantidadeDeIngressosASerComprada

    console.log(`Olá, ${nomeDoUsuario}. Você requereu ${quantidadeDeIngressosASerComprada} ingressos da ${etapaDoJogo} da categoria ${categoriaDoJogo}. Cada ingresso terá o valor de ${valorUnitarioDoIngresso} e o total a ser pago será de ${valorTotalDosIngressos}.`)
}